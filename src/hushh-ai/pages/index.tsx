          ...
          >
            <VStack h="full" p={4} spacing={4} align="stretch">
              ...
              <Box
                ...
                bg="linear-gradient(135deg, rgba(249, 115, 22, 0.1) 0%, rgba(249, 115, 22, 0.05) 100%)"
                _hover={{ 
                  bg: 'linear-gradient(135deg, rgba(249, 115, 22, 0.2) 0%, rgba(249, 115, 22, 0.1) 100%)',
                  transform: 'translateY(-1px)',
                  boxShadow: '0 4px 12px rgba(249, 115, 22, 0.15)'
                }}
                transition={THEME.transitions.fast}
                onClick={() => navigate('/hushh-ai/portfolio')}
              >
                <HStack spacing={3}>
                  ...
                  <VStack align="start" spacing={0}>
                    <Text fontSize={THEME.fontSizes.sm} fontWeight={THEME.fontWeights.medium} color={THEME.colors.textPrimary}>
                      Build Your Portfolio
                    </Text>
                    <Text fontSize="10px" color={THEME.colors.textSecondary}>
                      Own Your Story
                    </Text>
                  </VStack>
                </HStack>
